...
<p align="center">
  ...
  <a href="https://github.com/mongodb/kingfisher">
    <img src="https://img.shields.io/badge/Detection%20Rules-1004-2ea043.svg" alt="Detection Rules" style="height: 24px;" />
  </a>
  <br>
...
### Performance, Accuracy, and 1,004 Rules
- **Performance**: multithreaded, Hyperscan‑powered scanning built for huge codebases  
- **Extensible rules**: 1,004 built-in rules plus YAML-defined custom rules ([docs/RULES.md](/docs/RULES.md))
...
Kingfisher ships with [1,004 built-in rules](crates/kingfisher-rules/data/rules/) covering cloud keys, AI tokens, CI/CD secrets, database credentials, and SaaS API keys. Below is an overview — see the full list in [crates/kingfisher-rules/data/rules/](crates/kingfisher-rules/data/rules/):
...
Kingfisher ships with 1,004 built-in rules.
