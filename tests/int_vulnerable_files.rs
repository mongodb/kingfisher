...
async fn test_scan_vulnerable_files() -> Result<()> {
    ...
    let test_cases = vec![
        TestCase { file_name: "testdata/c_vulnerable.c", min_expected_findings: 1 },
        TestCase { file_name: "testdata/cpp_vulnerable.cpp", min_expected_findings: 1 },
        TestCase { file_name: "testdata/csharp_vulnerable.cs", min_expected_findings: 1 },
        TestCase { file_name: "testdata/elixir_vulnerable.exs", min_expected_findings: 1 },
        TestCase { file_name: "testdata/generic_secrets.py", min_expected_findings: 1 },
        TestCase { file_name: "testdata/go_vulnerable.go", min_expected_findings: 1 },
        TestCase { file_name: "testdata/java_vulnerable.java", min_expected_findings: 1 },
        TestCase { file_name: "testdata/javascript_vulnerable.js", min_expected_findings: 1 },
        TestCase { file_name: "testdata/json_vulnerable.json", min_expected_findings: 1 },
        TestCase { file_name: "testdata/objc_vulnerable.m", min_expected_findings: 1 },
        TestCase { file_name: "testdata/php_vulnerable.php", min_expected_findings: 1 },
        TestCase { file_name: "testdata/python_vulnerable.py", min_expected_findings: 1 },
        TestCase { file_name: "testdata/python2_vulnerable.py", min_expected_findings: 1 },
        TestCase { file_name: "testdata/ruby_vulnerable.rb", min_expected_findings: 1 },
        TestCase { file_name: "testdata/rust_vulnerable.rs", min_expected_findings: 1 },
        TestCase { file_name: "testdata/scala_vulnerable.scala", min_expected_findings: 1 },
        TestCase { file_name: "testdata/shell_vulnerable.sh", min_expected_findings: 1 },
        TestCase { file_name: "testdata/slack_tokens.properties", min_expected_findings: 1 },
        TestCase { file_name: "testdata/swift_vulnerable.swift", min_expected_findings: 1 },
        TestCase { file_name: "testdata/toml_vulnerable.toml", min_expected_findings: 1 },
        ...
        TestCase { file_name: "testdata/yaml_vulnerable.yaml", min_expected_findings: 1 },
    ];
