...
description: "Contain leaked credentials directly from the CLI with conservative provider-specific revocation flows."
---
...
See [USAGE.md](../usage/basic-scanning.md#direct-secret-revocation-with-kingfisher-revoke) for the command and
[RULES.md](../rules/overview.md) for the Kingfisher 1.x custom-rule schema.
