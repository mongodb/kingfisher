...
description: "Follow an end-to-end workflow for detecting, validating, notifying on, mapping, and revoking exposed credentials."
---
...
[Blast Radius](../features/blast-radius.md) for supported providers and credential requirements. Keep all
...
authorized to inspect the target account. See [Blast Radius](../features/blast-radius.md) for
...
See [Secret Revocation](../features/revocation.md) for supported families.
