...
Each machine-readable finding exposes its validation outcome. See [Finding Validation Statuses](#finding-validation-statuses) for the meaning of each human-readable result.
