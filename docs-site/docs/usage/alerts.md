...
description: "Send scan summaries and finding details to Slack, Teams, Discord, Mattermost, Google Chat, or any HTTPS webhook."
---
...
See [`docs/CONFIG.md`](../usage/configuration.md) for the full config schema.
